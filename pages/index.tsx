      ...
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .history-item {
          ...
          color: var(--text-secondary); font-size: 0.82rem; margin-bottom: 2px;
        ...
        .user-avatar {
          width: 30px; height: 30px; border-radius: 50%; background: #4ade80;
        ...
        .header-btn {
          ...
          cursor: pointer; padding: 6px 10px; border-radius: 6px; font-size: 0.875rem; transition: all 0.2s;
        }
        ...
        .message { display: flex; gap: 12px; max-width: 800px; margin: 0 auto; width: 100%; }
        .message-avatar {
        ...
        .message.user .message-content { background: var(--user-msg-bg); padding: 12px 16px; border-radius: 12px; }
        ...
        .typing-dot { width: 6px; height: 6px; border-radius: 50%; background: #6b7280; animation: tb 1.4s infinite; }
        ...
        .prompt-input {
          ...
          border-radius: 12px; color: var(--text-primary); font-size: 0.93rem;
          font-family: inherit; outline: none; resize: none; min-height: 48px; transition: border-color 0.2s;
        }
        ...
        .disclaimer { text-align: center; color: #6b7280; font-size: 0.72rem; padding: 6px; max-width: 800px; margin: 0 auto; }

        /* ── Scrollbars ── */
        .chat-messages::-webkit-scrollbar, .chat-history::-webkit-scrollbar { width: 4px; }
        .chat-messages::-webkit-scrollbar-track, .chat-history::-webkit-scrollbar-track { background: transparent; }
        .chat-messages::-webkit-scrollbar-thumb, .chat-history::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.1); border-radius: 2px; }

        /* ── Mobile ── */
        .menu-toggle { display: none; background: transparent; border: none; color: var(--text-secondary); cursor: pointer; font-size: 1.1rem; padding: 6px; }
        @media (max-width: 768px) {
          .sidebar { display: none; }
          .sidebar.mobile-open { display: flex; position: fixed; z-index: 50; height: calc(100% - 50px); top: 50px; }
